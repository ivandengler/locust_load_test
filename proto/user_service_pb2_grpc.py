...
import proto.user_service_pb2 as user__service__pb2
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMe = channel.unary_unary(
                '/pb.UserService/GetMe',
                request_serializer=user__service__pb2.GetMeRequest.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetMe': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMe,
                    request_deserializer=user__service__pb2.GetMeRequest.FromString,
...
class UserService(object):
    ...
    def GetMe(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/pb.UserService/GetMe',
            user__service__pb2.GetMeRequest.SerializeToString,
